package com.fhkg.androidflavors.appwidget;
...
/**
 * Created by houqixin on 2016/11/23.
 * http://blog.csdn.net/sasoritattoo/article/details/17616597
 */
public class QxAppWidgetProvider extends AppWidgetProvider {
    private static final String TAG = QxAppWidgetProvider.class.getSimpleName();
    ...
    private final String ACTION_UPDATE_ALL = "com.qx.widget.UPDATE_ALL";
...
//                    BUTTON_SHOW));
    ...
    private PendingIntent getPendingIntent(Context context, int buttonId) {
        ...
        intent.setClass(context, QxAppWidgetProvider.class);
